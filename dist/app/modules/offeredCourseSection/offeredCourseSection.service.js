...
const createOfferedCourseSection = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.offeredCourseSection.create({
        data,
    });
    return result;
});
...
const getSingleOfferedCourseSection = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "OfferedCourseSection Doesn't Exists");
    }
    return result;
});
const updateSingleOfferedCourseSection = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const isExists = yield prisma_1.default.offeredCourseSection.findUnique({
        where: { id },
    });
    if (!isExists) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "OfferedCourseSection Doesn't Exists");
...
const deleteSingleOfferedCourseSection = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const isExists = yield prisma_1.default.offeredCourseSection.findUnique({
        where: { id },
    });
    if (!isExists) {

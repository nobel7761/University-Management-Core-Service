...
const getSingleBuilding = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "Building Doesn't Exists");
    }
    return result;
});
const updateSingleBuilding = (data, id) => __awaiter(void 0, void 0, void 0, function* () {
    const isExists = yield prisma_1.default.building.findUnique({
        where: { id },
    });
    if (!isExists) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "Building Doesn't Exists");
...
const deleteSingleBuilding = (id) => __awaiter(void 0, void 0, void 0, function* () {

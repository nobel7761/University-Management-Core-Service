...
const getSingleStudent = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "Student Doesn't Exists");
    }
    return result;
});
const updateSingleStudent = (data, id) => __awaiter(void 0, void 0, void 0, function* () {
    const isExists = yield prisma_1.default.student.findUnique({
        where: { id },
    });
    if (!isExists) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "Student Doesn't Exists");
